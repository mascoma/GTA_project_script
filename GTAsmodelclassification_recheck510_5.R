...
outputdir <- paste("/isi/olga/xin/GTA_project/output/20160815/GTArecheckmodels_510_5", 
                   ".txt", sep = "")
...
array <- matrix(NA, nrow = 286, ncol = 9)
for (i in 611601: 611886) {
  ...
  array[(i-611600),] <- c(solve.output, pars)
  #print(i)
}
